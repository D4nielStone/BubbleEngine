...
bubbleui::contexto::contexto(GLFWwindow* window) : ancora_root(new bubbleui::ancora(Horizontal))
{
...
{
    contexto_atual->tamanho.y = height;
    contexto_atual->tamanho.x = width;
}
...
void bubbleui::contexto::atualizar()
{
    ...
    */
    ...
    ancora_root->bounds = {0, 0, tamanho.x, tamanho.y};
