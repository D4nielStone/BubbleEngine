...
BEUI_DLL_API void keyCallback(GLFWwindow* window, int key, int scancode, int action, int mods) {
...
BEUI_DLL_API void mousePosCallBack(GLFWwindow* window, double x, double y) {
    Inputs* inputs = static_cast<Inputs*>(glfwGetWindowUserPointer(window));
