...
namespace BubbleUI
{
	...
	public:
		// Construtores
		Painel(const Vector4<int>& rect);
		Painel(const char* n, const Vector4<int>& rect);
		Painel() = default;
		...
		virtual void definirContexto(std::shared_ptr<Contexto>, const char* nome, const Vector4<int>& rect);
